...
# Creates Solid Queue tables in the main database for development/test environments.
# Production uses a separate queue database (db/queue_schema.rb + config/database.yml
# "queue" entry), so this migration is skipped there.
#
# @since 2026-04-12

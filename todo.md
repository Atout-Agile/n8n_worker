...
## Assistant Personnel — Sous-projet S1 [✓ Created in n8n_worker project]

### S1 — Fondations + alertes RV sonores [✓ Created in n8n_worker project]
Sachant que l'utilisateur a plusieurs outils qui ne se parlent pas et une time blindness avérée
Afin de ne plus manquer ses rendez-vous (cible : < 1 RV manqué par semaine)
En tant qu'utilisateur
Je veux que le système surveille automatiquement mon agenda ICS, planifie des rappels à des intervalles configurables, et les émette en parallèle sur mes canaux (ntfy, email, webhook, canal interne, canaux partagés avec consentement explicite), avec une fenêtre de grâce post-début pour les retries

## Assistant Personnel — Sous-projets à venir [⌛ To create in n8n_worker project]

### S2 — Mémoire persistante Obsidian [⌛ To create in n8n_worker project]
Sachant que l'assistant a besoin de se souvenir de noms, contacts, marques, préférences entre sessions
Afin de ne pas faire répéter les mêmes informations à l'utilisateur
En tant qu'assistant autonome
Je veux pouvoir lire et écrire dans une base de connaissances Obsidian qui persiste au-delà des sessions

### S3 — Rapport matinal [⌛ To create in n8n_worker project]
Sachant que l'utilisateur veut commencer chaque journée avec une vision claire
Afin de préparer son Lucca et ses priorités
En tant que secrétaire autonome
Je veux produire chaque matin un récapitulatif agrégé depuis Calendar, JIRA, Slack, Memos et Obsidian

### S4 — Pré-remplissage Lucca CRA [⌛ To create in n8n_worker project]
Sachant que Lucca n'a pas d'API employé et que la saisie CRA est chronophage
Afin de réduire le temps passé à valider le CRA à moins de 30 secondes
En tant qu'utilisateur
Je veux une proposition pré-remplie basée sur l'activité effective de la veille